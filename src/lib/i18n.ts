  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        pleaseSignIn: "Please sign in to view job details",
      },
      // Dashboard
      dashboard: {
        title: "Dashboard",
        ...
        company: {
          ...
          panelLabel: "Company Panel",
          views: "Views",
          viewsThisMonth: "job views this month",
          ...
          sectorLabel: "Sector",
          registrationCountryLabel: "Registration Country",
          registrationNumberLabel: "Registration Number",
          registrationDocumentLabel: "Registration Document (Optional)",
          contactPersonNameLabel: "Contact Person Name",
          contactPersonPositionLabel: "Contact Person Position",
          contactPersonEmailLabel: "Contact Person Email",
          logoHelp: "PNG, JPG, JPEG (max 5MB)",
          companyProfilePlaceholder: "Enter company description/profile",
          fullNameEnPlaceholder: "Enter company name in English",
          fullNameArPlaceholder: "Enter company name in Arabic",
          sectorPlaceholder: "Select sector",
          registrationCountryPlaceholder: "Enter registration country",
          registrationNumberPlaceholder: "Enter registration number",
          viewCurrentFile: "View current file",
          registrationHelp: "PDF, DOC, DOCX, or Image (max 10MB)",
          viewRegistrationDocument: "View registration document",
          noFileUploaded: "No file uploaded",
          contactPersonNamePlaceholder: "Enter contact person name",
          contactPersonPositionPlaceholder: "Enter contact person position",
          contactPersonEmailPlaceholder: "Enter contact person email",
        ...
        organization: {
          ...
          fullNameEnLabel: "Full Name (English)",
          fullNameArLabel: "Full Name (Arabic)",
          fullNameEnPlaceholder: "Enter organization name in English",
          fullNameArPlaceholder: "Enter organization name in Arabic",
          registrationCountryLabel: "Registration Country",
          registrationCountryPlaceholder: "Enter registration country",
          registrationNumberLabel: "Registration Number",
          registrationNumberPlaceholder: "Enter registration number",
        ...
        admin: {
          ...
          latestActivities: "Latest platform activities",
          companyApprovalSummary: "{{pending}} pending • {{approved}} / {{total}} approved",
          applicationNumber: "Application #{{id}}",
          statusLabel: "Status:",
          ...
          createUserDescription: "Create a new user account with the specified role. The user will be automatically email-verified.",
          ...
          tenderDeleted: "Tender deleted successfully",
          tenderDeleteFailed: "Failed to delete tender",
          jobUpdated: "Job updated successfully",
          jobUpdateFailed: "Failed to update job",
          tenderUpdated: "Tender updated successfully",
          tenderUpdateFailed: "Failed to update tender",
          ...
          enable: "Enable",
          disable: "Disable",
          selectPostingType: "Select which posting type to enable",
          selectPostingTypeToDisable: "Select which posting type to disable",
          ...
          planManagementDescription: "Manage user plans and post limits",
      ...
      jobs: {
        ...
        fillApplicationForm: "Fill out the form below to apply for this position",
        coverLetter: "Cover Letter",
        coverLetterPlaceholder: "Tell us why you're a great fit for this role...",
        coverLetterRequired: "Cover letter is required",
        resumeUrl: "Resume URL",
        resumeUrlPlaceholder: "https://drive.google.com/...",
        resumeUrlHint: "Optional: Link to your resume (Google Drive, Dropbox, etc.)",
      ...
      tenders: {
        ...
        tenderNotFound: "Tender not found or has been removed",
        tenderDescription: "Tender Description",
        tenderDocuments: "Tender Documents",
        viewDocuments: "View Tender Documents",
        downloadDocument: "Download Tender Document",
  ...
  ar: {
    translation: {
      ...
      auth: {
        ...
        company: "شركة",
        organization: "منظمة",
        pleaseSignIn: "يرجى تسجيل الدخول لعرض تفاصيل الوظيفة",
      },
      // Dashboard
      dashboard: {
        title: "لوحة التحكم",
        ...
        company: {
          ...
          panelLabel: "لوحة الشركة",
          views: "المشاهدات",
          viewsThisMonth: "مشاهدات الوظائف هذا الشهر",
          outOfTotal: "من أصل {{total}}",
          applicationNumber: "الطلب رقم {{id}}",
          postedOn: "تم النشر في {{date}}",
          profileTitle: "الملف التعريفي للشركة",
          editProfile: "تعديل الملف",
          logoLabel: "الشعار",
          logoAlt: "شعار الشركة",
          companyProfileLabel: "الملف التعريفي للشركة",
          fullNameEnLabel: "الاسم الكامل (بالإنجليزية)",
          fullNameArLabel: "الاسم الكامل (بالعربية)",
          sectorLabel: "القطاع",
          registrationCountryLabel: "بلد التسجيل",
          registrationNumberLabel: "رقم التسجيل",
          registrationDocumentLabel: "وثيقة التسجيل (اختياري)",
          contactPersonNameLabel: "اسم جهة الاتصال",
          contactPersonPositionLabel: "منصب جهة الاتصال",
          contactPersonEmailLabel: "البريد الإلكتروني لجهة الاتصال",
          logoHelp: "PNG, JPG, JPEG (حد أقصى 5MB)",
          companyProfilePlaceholder: "أدخل وصف الشركة/نبذتها",
          fullNameEnPlaceholder: "أدخل اسم الشركة بالإنجليزية",
          fullNameArPlaceholder: "أدخل اسم الشركة بالعربية",
          sectorPlaceholder: "اختر القطاع",
          registrationCountryPlaceholder: "أدخل بلد التسجيل",
          registrationNumberPlaceholder: "أدخل رقم التسجيل",
          viewCurrentFile: "عرض الملف الحالي",
          registrationHelp: "PDF, DOC, DOCX, أو صورة (حد أقصى 10MB)",
          viewRegistrationDocument: "عرض وثيقة التسجيل",
          noFileUploaded: "لم يتم رفع ملف",
          contactPersonNamePlaceholder: "أدخل اسم جهة الاتصال",
          contactPersonPositionPlaceholder: "أدخل منصب جهة الاتصال",
          contactPersonEmailPlaceholder: "أدخل البريد الإلكتروني لجهة الاتصال",
        ...
        organization: {
          ...
          accept: "قبول",
          reject: "رفض",
          panelLabel: "لوحة المنظمة",
          profileTitle: "الملف التعريفي للمنظمة",
          editProfile: "تعديل الملف",
          logoLabel: "الشعار",
          logoAlt: "شعار المنظمة",
          logoHelp: "PNG, JPG, JPEG (حد أقصى 5MB)",
          fullNameEnLabel: "الاسم الكامل (بالإنجليزية)",
          fullNameArLabel: "الاسم الكامل (بالعربية)",
          fullNameEnPlaceholder: "أدخل اسم المنظمة بالإنجليزية",
          fullNameArPlaceholder: "أدخل اسم المنظمة بالعربية",
          registrationCountryLabel: "بلد التسجيل",
          registrationCountryPlaceholder: "أدخل بلد التسجيل",
          registrationNumberLabel: "رقم التسجيل",
          registrationNumberPlaceholder: "أدخل رقم التسجيل",
        ...
        admin: {
          ...
          sections: {
            ...
            usersOrganizations: "المستخدمون والمنظمات",
            jobsTenders: "الوظائف والمناقصات",
          },
          ...
          open: "مفتوح",
          closed: "مغلق",
          closingSoon: "ينتهي قريبًا",
          pendingApprovals: "الموافقات المعلقة",
          latestActivities: "أحدث أنشطة المنصة",
          companyApprovalSummary: "{{pending}} قيد الانتظار • {{approved}} / {{total}} معتمد",
          applicationNumber: "الطلب رقم {{id}}",
          statusLabel: "الحالة:",
          ...
          jobTypeContract: "عقد",
          jobTypeRemote: "عن بعد",
          userDeleted: "تم حذف المستخدم بنجاح",
          userDeleteFailed: "فشل حذف المستخدم",
          userCreated: "تم إنشاء المستخدم بنجاح",
          userCreateFailed: "فشل إنشاء المستخدم",
          createUser: "إنشاء مستخدم",
          createUserDescription: "إنشاء حساب مستخدم جديد بالدور المحدد. سيتم التحقق من البريد الإلكتروني تلقائياً.",
          passwordRequirements: "يجب أن تكون كلمة المرور 8 أحرف على الأقل وتحتوي على حرف كبير وصغير ورقم ورمز خاص (@$!%*?&)",
          creating: "جاري الإنشاء...",
          jobDeleted: "تم حذف الوظيفة بنجاح",
          jobDeleteFailed: "فشل حذف الوظيفة",
          tenderDeleted: "تم حذف المناقصة بنجاح",
          tenderDeleteFailed: "فشل حذف المناقصة",
          jobUpdated: "تم تحديث الوظيفة بنجاح",
          jobUpdateFailed: "فشل تحديث الوظيفة",
          tenderUpdated: "تم تحديث المناقصة بنجاح",
          tenderUpdateFailed: "فشل تحديث المناقصة",
          companyUpdated: "تم تحديث الشركة بنجاح",
          companyUpdateFailed: "فشل تحديث الشركة",
          organizationUpdated: "تم تحديث المنظمة بنجاح",
          organizationUpdateFailed: "فشل تحديث المنظمة",
          ...
          enable: "تفعيل",
          disable: "تعطيل",
          selectPostingType: "اختر نوع النشر المراد تفعيله",
          selectPostingTypeToDisable: "اختر نوع النشر المراد تعطيله",
          postingType: "نوع النشر",
          both: "كلاهما",
          forCompany: "للشركة",
          forOrganization: "للمنظمة",
          users: "المستخدمون",
          companies: "الشركات",
          ...
          planManagementDescription: "إدارة خطط المستخدمين وحدود النشر",
      ...
      jobs: {
        ...
        applyForJob: "التقدم للوظيفة",
        applyNow: "تقدم الآن",
        applicationSubmitted: "تم إرسال الطلب",
        applicationFailed: "فشل إرسال الطلب",
        alreadyApplied: "تم التقدم مسبقاً",
        applicationStatus: "حالة الطلب",
        fillApplicationForm: "املأ النموذج أدناه للتقدم لهذا المنصب",
        coverLetter: "رسالة التغطية",
        coverLetterPlaceholder: "أخبرنا لماذا أنت مناسب لهذا الدور...",
        coverLetterRequired: "رسالة التغطية مطلوبة",
        resumeUrl: "رابط السيرة الذاتية",
        resumeUrlPlaceholder: "https://drive.google.com/...",
        resumeUrlHint: "اختياري: رابط لسيرتك الذاتية (Google Drive، Dropbox، إلخ)",
      ...
      tenders: {
        ...
        projectSummary: "ملخص المشروع",
        requirements: "المتطلبات",
        backToTenders: "العودة إلى المناقصات",
        tenderNotFound: "المناقصة غير موجودة أو تم حذفها",
        tenderDescription: "وصف المناقصة",
        tenderDocuments: "مستندات المناقصة",
        viewDocuments: "عرض مستندات المناقصة",
        downloadDocument: "تحميل مستند المناقصة",
        tenderInformation: "معلومات المناقصة",
        postedOn: "تم النشر في",
        publisherInfo: "معلومات المعلن",
        category: "الفئة",
        description: "الوصف",
        day: "يوم",
        days: "أيام",
